...
export default function WorkerSearch() {
  ...
  const filtered = workers.filter((w) => {
    ...
    const matchCategory = !activeCategory || activeCategory === "Todos" || w.category === activeCategory;
  ...
  return (
    <div className="min-h-full bg-gray-50 pb-16">
      ...
      <div className="px-5 mt-4 space-y-3">
        {filtered.map((w) => (
          <div key={w.id} className="bg-white rounded-2xl shadow-sm p-3 flex items-center gap-3">
