...
import { User, Mail, Phone, MapPin, Calendar, Save, CheckCircle, Briefcase, DollarSign } from "lucide-react";
    ...
    <div className="min-h-full bg-gray-50">
      ...
      <div className="px-5 pt-4">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-4 mb-4">
          <h3 className="text-sm font-bold text-gray-800 mb-3">Información Profesional</h3>
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              <Briefcase className="w-5 h-5 text-gray-400" />
              <span className="text-sm text-gray-700">Electricista certificado</span>
            </div>
            <div className="flex items-center gap-3">
              <DollarSign className="w-5 h-5 text-gray-400" />
              <span className="text-sm text-gray-700">S/ 70 por servicio</span>
            </div>
          </div>
        </div>
